...
class RMS:
    def __init__(self, root):
        ...
        footer = Label(self.root, text="SRMS-Student Result Management System\nContact us for any Technical Issue: 7016596277",font=('goudy old style',12,),bg='#262626',fg='white').pack(side=BOTTOM,fill=X)
        ...
        self.bg_img1 = self.bg_img1.resize((340, 430), Image.ANTIALIAS)
        self.bg_img1 = ImageTk.PhotoImage(self.bg_img1)

        self.lbl_bg1 = Label(self.root, image=self.bg_img1).place(x=40, y=180, width=350, height=450)
