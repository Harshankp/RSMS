...
class reportClass:
    def __init__(self, root):
        ...
        self.btn_search = Button(self.root, text='Search', font=('goudy old style', 15, 'bold'), bg='#03a9f4', fg='white',cursor='hand2',command=self.search).place(x=680, y=100, width=100, height=35)
        self.btn_clear = Button(self.root, text='Clear', font=('goudy old style', 15, 'bold'), bg='gray', fg='white',cursor='hand2',command=self.clear).place(x=800, y=100, width=100, height=35)
        ...
        self.btn_delete = Button(self.root, text='Delete', font=('goudy old style', 15, 'bold'), bg='red', fg='white',cursor='hand2',command=self.delete).place(x=500, y=350, width=150, height=35)
