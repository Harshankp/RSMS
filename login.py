...
class Login:
    ...
    def loginform(self):
        ...
        self.img = ImageTk.PhotoImage(file="images/img24.jpg")
        img = Label(Frame_login, image=self.img).place(x=0, y=0, width=1366, height=700)

        frame_input = Frame(self.root, bg='white')
        frame_input.place(x=320, y=130, height=420, width=350)

        label1 = Label(frame_input, text="Login Here", font=('impact', 32, 'bold'),fg="black", bg='white')
        label1.place(x=75, y=20)

        label2 = Label(frame_input, text="Email", font=("Goudy old style", 20, "bold"),fg='#151E3D', bg='white')
        ...
        label3 = Label(frame_input, text="Password", font=("Goudy old style", 20, "bold"),fg='#151E3D', bg='white')
        ...
        btn2 = Button(frame_input, text="Login", command=self.login, cursor="hand2",  font=("times new roman", 15), fg="white", bg="#151E3D",bd=0, width=15, height=1)
        btn2.place(x=90, y=310)
    ...
    def login(self):
        if self.email_txt.get() == "" or self.password.get() == "":
            ...
            try:
                con = pymysql.connect(host='localhost', user='root', password='hansu#3597', database='pythongui')
                cur = con.cursor()
    ...
    def Register(self):
        ...
        label2 = Label(frame_input2, text="Username", font=("Goudy old style", 20, "bold"),fg='#151E3D', bg='white')
        label2.place(x=30, y=95)

        self.entry = Entry(frame_input2, font=("times new roman", 15, "bold"), bg='lightgray')
        self.entry.place(x=30, y=145, width=270, height=35)

        label3 = Label(frame_input2, text="Password", font=("Goudy old style", 20, "bold"),fg='#151E3D', bg='white')
        label3.place(x=30, y=195)
        ...
        label4 = Label(frame_input2, text="Email-id", font=("Goudy old style", 20, "bold"), fg='#151E3D', bg='white')
        ...
        label5 = Label(frame_input2, text="Confirm Password",font=("Goudy old style", 20, "bold"), fg='#151E3D', bg='white')
        ...
        btn2 = Button(frame_input2, command=self.register, text="Register", cursor="hand2", font=("times new roman", 15), fg="white",bg="#151E3D", bd=0, width=15, height=1)
    ...
    def register(self):
        if self.entry.get() == "" or self.entry2.get() == "" or self.entry3.get() == "" or self.entry4.get() == "":
            ...
            try:
                ...
                elif not re.search(regex,self.entry3.get()):
                    messagebox.showerror("Error", "please write valid email address", parent=self.root)
