...
class resultClass:
    def __init__(self, root):
        ...
        self.btn_search = Button(self.root, text='Search', font=('goudy old style', 15, 'bold'), bg='#03a9f4', fg='white',cursor='hand2',command=self.search).place(x=500, y=100, width=100, height=28)
